...
export const metadata = {
    ...
    description: 'Team Project Europaの技術スキルと認定資格一覧。AWS全12資格、Google Cloud 6資格を保有。',
};
...
const awsCerts: CertItem[] = [
    {
        ...
        descJp: "AWSの最上位資格の一つ。スケーラブルで高可用性のクラウドアーキテクチャを設計・実装する専門的なスキルを認定。",
        iconPath: "M13.5,7A6.5,6.5 0 0,1 20,13.5A6.5,6.5 0 0,1 13.5,20H10V18H13.5C16,18 18,16 18,13.5C18,11 16,9 13.5,9H7.83L10.91,12.09L9.5,13.5L4,8L9.5,2.5L10.91,3.91L7.83,7H13.5M6,18H8V20H6V18Z"
    },
    {
        ...
        descJp: "CI/CDパイプラインの実装とインフラ自動化に関する専門的なスキルを認定する上級資格。",
        iconPath: "M12,1.5A10.5,10.5 0 0,1 22.5,12A10.5,10.5 0 0,1 12,22.5A10.5,10.5 0 0,1 1.5,12A10.5,10.5 0 0,1 12,1.5M12,3.5A8.5,8.5 0 0,0 3.5,12A8.5,8.5 0 0,0 12,20.5A8.5,8.5 0 0,0 20.5,12A8.5,8.5 0 0,0 12,3.5M17,6.5L15.5,8.5L17.5,11H14V13H17.5L15.5,15.5L17,17.5L22,12L17,6.5M7,6.5L2,12L7,17.5L8.5,15.5L6.5,13H10V11H6.5L8.5,8.5L7,6.5Z"
    },
    {
        ...
        descJp: "AWS インフラストラクチャ上での複雑なネットワーキングソリューションの設計、開発、デプロイに関する専門知識。",
        iconPath: "M15,20A1,1 0 0,0 16,19V4H8A1,1 0 0,0 7,5V16H5V5A3,3 0 0,1 8,2H19A3,3 0 0,1 22,5V19A3,3 0 0,1 19,22H15V20M1,15H3V17H1V15M1,11H3V13H1V11M1,7H3V9H1V7M1,3H3V5H1V3M5,3H7V5H5V3M5,19H7V21H5V19M5,11H7V13H5V11M5,7H7V9H5V7M9,3H11V5H9V3M9,19H11V21H9V19Z"
    },
    {
        title: "Security Specialty",
        desc: "Specialized knowledge in securing AWS infrastructure and implementing compliance frameworks.",
        descJp: "AWSインフラストラクチャのセキュリティ強化とコンプライアンスフレームワークの実装に関する専門知識。",
        iconPath: "M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,5A3,3 0 0,1 15,8A3,3 0 0,1 12,11A3,3 0 0,1 9,8A3,3 0 0,1 12,5M17.13,17C15.92,18.85 14.11,20.24 12,20.92C9.89,20.24 8.08,18.85 6.87,17C6.53,16.5 6.24,16 6,15.47C6,13.82 8.71,12.47 12,12.47C15.29,12.47 18,13.79 18,15.47C17.76,16 17.47,16.5 17.13,17Z"
    },
    {
        title: "Machine Learning Specialty",
        desc: "Expertise in designing, implementing, and deploying machine learning solutions on AWS.",
        descJp: "AWSにおける機械学習ソリューションの設計、実装、デプロイに関する専門知識。",
        iconPath: "M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M12,10A2,2 0 0,0 10,12A2,2 0 0,0 12,14A2,2 0 0,0 14,12A2,2 0 0,0 12,10M7,5A2,2 0 0,0 5,7A2,2 0 0,0 7,9A2,2 0 0,0 9,7A2,2 0 0,0 7,5M17,15A2,2 0 0,0 15,17A2,2 0 0,0 17,19A2,2 0 0,0 19,17A2,2 0 0,0 17,15Z"
    },
    {
        title: "Solutions Architect Associate",
        desc: "Capable of designing available, cost-efficient, fault-tolerant systems on AWS.",
        descJp: "可用性が高く、コスト効率の良い耐障害性システムをAWS上で設計する能力。",
        iconPath: "M18,9V10.5L21,7.5L18,4.5V6H15V9H18M14,10H3V12H14V10M14,6H3V8H14V6M3,16H10V14H3V16Z"
    },
    {
        ...
        iconPath: "M15,17H17V14H19V17H21V19H19V22H17V19H15V17M13,13H7V11H13V13M13,9H7V7H13V9M7,15H13V17H7V15M21,3V9H3V3H21M19,5H5V7H19V5Z"
    },
    {
    ...
    },
    {
        ...
        descJp: "セキュリティ、回復力、パフォーマンスに焦点を当てたデータ処理システムの設計、実装、保守における専門知識。",
    ...
    },
    {
        ...
        descJp: "事前トレーニング済みのAIサービスとMLフレームワークを使用したAWS上のML解決策実装に関する準専門レベルの認定資格。",
        iconPath: "M16,3C14.89,3 14,3.89 14,5V9C14,10.11 14.89,11 16,11H20V13H17.5C16.12,13 15,14.12 15,15.5V16.27C14.23,16.62 13.54,17.13 13,17.77L12,18.77C10.29,20.5 9,22 5,22V20C8,20 8.68,19 10,17.77L11.06,16.72C10.55,15.84 10.25,14.83 10.16,13.78C8.9,13.4 8,12.3 8,11V9C8,7.7 9.34,6.8 11,7.2V5C11,3.89 10.11,3 9,3H5C3.89,3 3,3.89 3,5V19C3,20.11 3.89,21 5,21H9C10.11,21 11,20.11 11,19V15.5C11,14.12 12.12,13 13.5,13H20V11H18.65C18.87,10.69 19,10.35 19,10V9H22V5C22,3.89 21.11,3 20,3H16M16,5H20V9H16V5M9,11H5V9H9V11M9,15H5V13H9V15M9,19H5V17H9V19Z"
    },
    {
        title: "AI Practitioner",
        desc: "Foundational certification for applying AI services in real-world applications.",
        descJp: "実世界のアプリケーションでAIサービスを適用するための基礎的な認定資格。AWS AI/MLツールとベストプラクティスに焦点を当てています。",
        iconPath: "M21,16.5C21,16.88 20.79,17.21 20.47,17.38L12.57,21.82C12.41,21.94 12.21,22 12,22C11.79,22 11.59,21.94 11.43,21.82L3.53,17.38C3.21,17.21 3,16.88 3,16.5V7.5C3,7.12 3.21,6.79 3.53,6.62L11.43,2.18C11.59,2.06 11.79,2 12,2C12.21,2 12.41,2.06 12.57,2.18L20.47,6.62C20.79,6.79 21,7.12 21,7.5V16.5M12,4.15L5,8.09V15.91L12,19.85L19,15.91V8.09L12,4.15Z"
    },
    {
        title: "Cloud Practitioner",
        desc: "Comprehensive understanding of the AWS Cloud, its services, and basic architecture patterns.",
        descJp: "AWSクラウド、そのサービス、および基本的なアーキテクチャパターンの包括的な理解。",
...
const gcpCerts: CertItem[] = [
    {
        ...
        descJp: "Google Cloud上でセキュアでスケーラブルなクラウドソリューションを設計・開発・管理する専門的なスキルを認定。",
        iconPath: "M12,2L2,7L12,12L22,7L12,2M2,17L12,22L22,17L12,12L2,17M12,14.5L4.5,10L12,5.5L19.5,10L12,14.5Z"
    },
    {
        ...
        descJp: "Google Cloud推奨のプラクティスとツールを使用して、スケーラブルで高可用性のアプリケーションを構築する専門的なスキルを認定。",
    ...
    },
    {
        ...
        descJp: "Google Cloud上でのアプリケーションのデプロイ、運用監視、エンタープライズソリューションの管理に関する認定資格。",
        iconPath: "M12,7V4H8V7H5V11H8V14H5V18H8V21H12V18H15V21H19V18H22V14H19V11H22V7H19V4H15V7H12M12,11H15V14H12V11Z"
    },
    {
        ...
        descJp: "Google CloudインフラストラクチャにおけるDevOps実践、SRE原則、CI/CDパイプラインの実装に関する専門的なスキルを認定。",
        iconPath: "M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M16,6L14.5,8.5L17,11H14V13H17L14.5,15.5L16,18L21,12L16,6M8,6L3,12L8,18L9.5,15.5L7,13H10V11H7L9.5,8.5L8,6Z"
    },
    {
        title: "Generative AI Leader",
        desc: "Demonstrating leadership skills in applying generative AI technologies and strategies.",
        descJp: "生成AI技術と戦略を活用してビジネス変革とイノベーションを推進するリーダーシップスキルを証明する認定資格。",
        iconPath: "M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.46,13.97L5.82,21L12,17.27M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9Z"
    },
    {
        title: "Cloud Digital Leader",
        desc: "Foundational certification demonstrating knowledge of cloud concepts and Google Cloud products and services.",
        descJp: "クラウドの概念とGoogle Cloudの製品・サービスに関する知識を証明する基礎的な認定資格。",
...
const techStack: CertItem[] = [
    {
        ...
        descJp: "JavaScriptとTypeScriptを使用したモダンなフロントエンドおよびバックエンド開発。",
        iconPath: "M3,3H21V21H3V3M7.73,18.04C8.13,18.89 8.92,19.59 10.27,19.59C11.77,19.59 12.8,18.79 12.8,17.04V11.26H11.1V17C11.1,17.86 10.75,18.08 10.2,18.08C9.62,18.08 9.38,17.68 9.11,17.21L7.73,18.04M13.71,17.86C14.21,18.84 15.22,19.59 16.8,19.59C18.4,19.59 19.6,18.76 19.6,17.23C19.6,15.82 18.79,15.19 17.35,14.57L16.93,14.39C16.2,14.08 15.89,13.87 15.89,13.37C15.89,12.96 16.2,12.64 16.7,12.64C17.18,12.64 17.5,12.85 17.79,13.37L19.1,12.5C18.55,11.54 17.77,11.17 16.7,11.17C15.19,11.17 14.22,12.13 14.22,13.4C14.22,14.78 15.03,15.43 16.25,15.95L16.67,16.13C17.45,16.47 17.91,16.68 17.91,17.26C17.91,17.74 17.46,18.09 16.76,18.09C15.93,18.09 15.45,17.66 15.09,17.06L13.71,17.86Z"
    },
    {
        title: "Vue.js / Nuxt.js",
        desc: "Creating dynamic, progressive web applications using Vue.js ecosystem.",
        descJp: "Vue.jsエコシステムを活用した動的でプログレッシブなWebアプリケーションの開発。",
...
export default function SkillPage() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mb-12">
                <CyberCard title="Skills Database">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-sm md:text-base text-cyber-light opacity-80 mb-6 font-mono border-b border-cyber-blue/30 pb-2 inline-block">技術スキル一覧</p>
                        <p className="leading-relaxed text-foreground/90 max-w-3xl mx-auto">
                            Team Project Europaが持つ技術スキルと認定資格の一覧です。クラウドインフラ、Webアプリケーション開発、システム設計など幅広い分野に対応しています。
                        </p>
                    </div>
                </CyberCard>
            </section>
                ...
                <CyberCard title="Qualification Records">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {awsCerts.map((cert, index) => (
                            <div key={index} className="bg-cyber-black/40 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue hover:shadow-[0_0_15px_rgba(38,218,253,0.3)] transition-all duration-300 flex flex-col items-center text-center group">
                                <div className="w-16 h-16 bg-cyber-blue/10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 border border-cyber-blue/30 group-hover:border-cyber-blue">
                                    <svg viewBox="0 0 24 24" className="w-8 h-8 text-cyber-blue group-hover:text-white transition-colors duration-300" fill="currentColor">
                                        <path d={cert.iconPath} />
                                    </svg>
                                </div>
                                <h3 className="text-lg font-bold text-cyber-blue mb-2">{cert.title}</h3>
                                <p className="text-sm opacity-70 mb-2">{cert.desc}</p>
                                <p className="text-xs text-cyber-light border-t border-cyber-blue/20 pt-2 w-full">{cert.descJp}</p>
                            </div>
                        ))}
                    </div>

                    <div className="mt-8 p-4 bg-cyber-blue/5 border border-cyber-blue/30 rounded text-center">
                        <p className="font-bold text-cyber-blue mb-1">※ AWS の全ての認定資格を取得しています。</p>
            ...
            <section className="mb-12">
                <CyberCard title="Qualification Records">
                    <SectionTitle title="Google Cloud Certifications" subtitle="Google Cloud認定資格" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {techStack.map((item, index) => (
                            <div key={index} className="bg-cyber-black/40 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue hover:shadow-[0_0_15px_rgba(38,218,253,0.3)] transition-all duration-300 flex flex-col items-center text-center group">
                                ...
                                <h3 className="text-lg font-bold text-cyber-blue mb-2">{item.title}</h3>
                                <p className="text-sm opacity-70 mb-2">{item.desc}</p>
                                <p className="text-xs text-cyber-light border-t border-cyber-blue/20 pt-2 w-full">{item.descJp}</p>
                            </div>
                        ))}
                    </div>
                </CyberCard>
            ...
            <section className="mb-12">
                <CyberCard title="Detailed Technical Skills">
                    <SectionTitle title="Tech Stack & Capabilities" subtitle="技術スタックと対応領域" />
