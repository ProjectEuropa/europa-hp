      ...
      <section className="mb-12">
        <CyberCard title="Mission Statement">
          ...
          <div className="text-foreground/90 space-y-6 leading-relaxed">
            <p>
              Team Project
              Europaは、技術の力で人々の生活と仕事を向上させることを目指すテクノロジー集団です。私たちの名前「Europa」は、木星の衛星であり、生命が存在する可能性を秘めた場所からインスピレーションを得ています。未知の可能性を探求し、革新的なソリューションを生み出すという私たちの姿勢を象徴しています。
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            ...
            <div className="bg-cyber-blue/5 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue transition-colors duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-sm opacity-80">
                クライアントとの緊密な連携を通じて、真のニーズに応えるソリューションを提供します
              </p>
            </div>
            ...
            <div className="bg-cyber-blue/5 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue transition-colors duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-sm opacity-80">
                最新のAI技術を活用し、開発プロセスを加速させながら革新的なソリューションを提供します
              </p>
            </div>
          </div>
        </CyberCard>
      ...
      <section className="mb-12">
        <CyberCard title="Team Members">
          ...
          <div className="border border-cyber-blue/30 bg-cyber-blue/5 p-6 rounded hover:border-cyber-blue transition-all duration-300">
            ...
            <p className="text-sm text-cyber-light font-mono mb-4 border-b border-cyber-blue/20 pb-2 inline-block">
              Lead Developer & Cloud Architect
            </p>
            <p className="text-sm mb-4 leading-relaxed">
              AWSおよびGoogle
              Cloudの認定資格を保持するクラウドスペシャリスト。複層的なインフラ設計から効率的なアプリケーション開発まで幅広く対応。
            </p>
        ...
        <CyberCard title="Our Approach">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-cyber-blue/5 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue transition-colors duration-300">
              ...
              <h3 className="text-base font-bold text-cyber-blue mb-2">
                技術的卓越性
              </h3>
              <p className="text-sm opacity-80">
                AWS認定資格を全て取得するなど、常に最高レベルの技術力を追求しています。理論だけでなく実践的な知識と経験を重視し、確実な成果を提供します。
              </p>
            </div>
            ...
            <div className="bg-cyber-blue/5 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue transition-colors duration-300">
              ...
              <p className="text-sm opacity-80">
                インフラ設計からアプリケーション開発、運用保守まで一貫したサービスを提供。複数のベンダーを管理する必要がなく、効率的なプロジェクト進行が可能です。
              </p>
            </div>
            ...
            <div className="bg-cyber-blue/5 border border-cyber-blue/20 p-6 rounded hover:border-cyber-blue transition-colors duration-300">
              ...
              <p className="text-sm opacity-80">
                将来の拡張性を考慮した設計を心がけています。ビジネスの成長に合わせて柔軟にスケールできるソリューションを提供します。
              </p>
            </div>
          </div>
        </CyberCard>
          ...
          <div className="space-y-6">
            <div className="border border-cyber-blue/30 p-5 rounded bg-cyber-blue/5">
              <div className="text-center mb-2">
                ...
                <span className="text-xs font-mono text-cyber-light bg-cyber-blue/10 px-2 py-1 rounded mt-1 inline-block">
                  2024-現在
                </span>
              </div>
              <p className="text-sm mb-3 text-foreground/80">
                大手重工業系企業、大手通信企業、大手データ分析企業、大手飲料メーカーなど、複数の大手企業にて新卒エンジニア向けの技術研修を担当。
              </p>
              <div className="flex flex-wrap gap-2 justify-center">
                {["AWS", "生成AI"].map((skill) => (
                  <TechTag key={skill}>{skill}</TechTag>
        ...
        <CyberCard title="Achievements">
          ...
          <div className="space-y-6">
            <div className="border border-cyber-blue/30 p-5 rounded bg-cyber-blue/5">
              ...
              <p className="text-sm mb-3 text-foreground/80">
                Google
                Cloudを基盤とした消費者向け生活支援サービスの新規開発および基幹システムの運用保守。CI/CDパイプラインの構築、TerraformによるIaC、生成AIを活用したPR自動レビュー機能、セキュリティ対策などを実施。
              </p>
              <div className="flex flex-wrap gap-2 justify-center">
                {[
                  "Cloud Run",
            ...
            <div className="border border-cyber-blue/30 p-5 rounded bg-cyber-blue/5">
              ...
              <p className="text-sm mb-3 text-foreground/80">
                AWS CDKとAurora
                MySQLを活用し、数十万件のデータベースレコードを1〜2秒で検索できる高速システムを実現。複数のデータソースを統合し、インデックス最適化とキャッシュ戦略を駆使して応答時間を劇的に改善。
              </p>
              <div className="flex flex-wrap gap-2 justify-center">
                {[
                  "AWS ECS",
            ...
            <div className="text-center mt-6">
              <Link
                href="/portfolio"
                className="inline-block px-8 py-3 bg-cyber-blue/10 border border-cyber-blue text-cyber-blue hover:bg-cyber-blue hover:text-cyber-black transition-all duration-300 uppercase tracking-widest text-sm shadow-[0_0_10px_rgba(38,218,253,0.3)] hover:shadow-[0_0_20px_rgba(38,218,253,0.6)]"
              >
                View Full Portfolio
              </Link>
            </div>
