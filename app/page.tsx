        ...
        <CyberCard title="System Message" className="relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="leading-relaxed text-foreground/90 max-w-3xl mx-auto mb-6">
              Team Project
              Europaは、スケーラブルなクラウドインフラストラクチャの構築と、新卒エンジニア向け技術研修を提供するプロフェッショナルチームです。
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              <Link
                href="/contact"
                className="inline-block px-6 sm:px-8 py-3 bg-cyber-blue/10 border border-cyber-blue text-cyber-blue hover:bg-cyber-blue hover:text-cyber-black transition-all duration-300 uppercase tracking-widest text-xs sm:text-sm shadow-[0_0_10px_rgba(38,218,253,0.3)] hover:shadow-[0_0_20px_rgba(38,218,253,0.6)]"
              >
                Contact Us
              </Link>
              <Link
                href="/portfolio"
                className="inline-block px-6 sm:px-8 py-3 bg-transparent border border-gray-600 text-foreground hover:border-cyber-blue hover:text-cyber-blue transition-all duration-300 uppercase tracking-widest text-xs sm:text-sm"
              >
                View Portfolio
              </Link>
            </div>
          ...
          <CyberCard title="Proven Track Record">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-center">
              ...
              <div className="border border-cyber-blue/30 p-5 hover:border-cyber-blue transition-colors duration-300 bg-cyber-black/40 flex flex-col">
                ...
                <p className="text-sm mb-3 flex-grow text-left">
                  Google Cloud &
                  Laravelを基盤とした大規模ユーザー向けプラットフォーム開発。CI/CD、IaCなどモダンなDevOpsを導入。
                </p>
              ...
              <div className="border border-cyber-blue/30 p-5 hover:border-cyber-blue transition-colors duration-300 bg-cyber-black/40 flex flex-col">
                ...
                <p className="text-sm mb-3 flex-grow text-left">
                  AWS ECS &
                  Auroraを活用し、数百万件のレコードをサブ秒レイテンシで処理する高性能な検索システムを開発。
                </p>
                <div className="flex flex-wrap gap-2 justify-center border-t border-cyber-blue/20 pt-3 mt-auto">
                  {[
                    "AWS ECS",
              ...
              <div className="border border-cyber-blue/30 p-5 hover:border-cyber-blue transition-colors duration-300 bg-cyber-black/40 flex flex-col">
                ...
                <p className="text-sm mb-3 flex-grow text-left">
                  新卒エンジニア向けの技術研修講師として、クラウドアーキテクチャやDevOpsのベストプラクティスを指導。
                </p>
                <div className="flex flex-wrap gap-2 justify-center border-t border-cyber-blue/20 pt-3 mt-auto">
                  {[
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 mt-6 border-t border-cyber-blue/20 pt-6">
              <div className="flex items-center justify-center gap-3 p-3 bg-cyber-black/40 border border-cyber-blue/20 rounded hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-left">
                  <h4 className="font-bold text-cyber-blue text-sm">
                    AWS All Certifications
                  </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-foreground">
              ...
              <div className="group p-5 transition-all duration-300">
                <div className="mx-auto w-16 h-16 bg-cyber-blue/10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 border border-cyber-blue/30 group-hover:border-cyber-blue group-hover:shadow-[0_0_15px_rgba(38,218,253,0.5)]">
                  <svg
                    className="w-8 h-8 text-cyber-blue group-hover:animate-pulse"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                ...
                <h3 className="font-mono text-xl text-cyber-blue mb-2">
                  Cloud Infrastructure
                </h3>
                <p className="text-sm mb-1 opacity-90">
                  We build and manage scalable cloud infrastructure solutions.
                </p>
                <p className="text-xs opacity-70">
                  スケーラブルなクラウドインフラストラクチャソリューションの構築と管理を行っています。
                </p>
              </div>
              ...
              <div className="group p-5 transition-all duration-300">
                ...
                <p className="text-sm mb-1 opacity-90">
                  We provide technical training for new graduates.
                </p>
                <p className="text-xs opacity-70">
                  新卒エンジニア向けの技術研修を提供します。
                </p>
              </div>
              ...
              <div className="group p-5 transition-all duration-300">
                ...
                <p className="text-sm mb-1 opacity-90">
                  We will accept requests for web applications.
                </p>
                <p className="text-xs opacity-70">
                  Webアプリケーション制作を受託します。
                </p>
