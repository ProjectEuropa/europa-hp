...
export default function ContactPage() {
	...
	const submitToNetlify = async () => {
		...
		setSubmitError(null);
		try {
			const realForm = document.getElementById(
				"contactForm",
			) as HTMLFormElement;
				...
				<CyberCard title="Message Transmission">
					...
					>
						...
						<div className="space-y-2">
							<label
								htmlFor="name"
								className="block text-cyber-blue font-mono text-sm tracking-wider"
							>
						...
						<div className="space-y-2">
							...
							>
								EMAIL{" "}
								<span className="text-xs opacity-70 ml-2">メールアドレス</span>
							</label>
							<input
								type="email"
								id="email"
						...
						<div className="space-y-2">
							...
							>
								MESSAGE{" "}
								<span className="text-xs opacity-70 ml-2">メッセージ</span>
							</label>
							<textarea
								id="message"
								name="message"
						...
						<div className="space-y-2">
							...
							>
								FILE UPLOAD{" "}
								<span className="text-xs opacity-70 ml-2">ファイル添付</span>
							</label>
							<div className="relative">
								...
								<label
									htmlFor="file"
									className="inline-block px-6 py-2 bg-cyber-blue/10 border border-cyber-blue/50 text-cyber-blue cursor-pointer hover:bg-cyber-blue hover:text-cyber-black transition-all duration-300 text-sm font-mono tracking-wider"
								>
									SELECT FILE
								</label>
					...
					<div className="w-full max-w-lg mx-4">
						<CyberCard title="CONFIRM TRANSMISSION">
							<div className="space-y-6">
								<h3 className="text-lg font-bold text-cyber-blue text-center mb-4">
								...
								<div className="space-y-4 border-t border-b border-cyber-blue/30 py-4 max-h-[60vh] overflow-y-auto">
									...
									<div className="grid grid-cols-[100px_1fr] gap-4">
										...
										<div className="text-foreground text-sm whitespace-pre-wrap break-words max-h-40 overflow-y-auto custom-scrollbar">
											{formState.message}
										</div>
									</div>
									<div className="grid grid-cols-[100px_1fr] gap-4">
										...
										<div className="text-foreground text-sm break-words">
											{formState.file ? formState.file.name : "None"}
										</div>
									</div>
								</div>
