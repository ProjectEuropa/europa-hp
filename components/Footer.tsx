            ...
            <div className="container mx-auto px-8">
                <CyberCard title="Communication Links" className="mb-0">
                    <div className="flex justify-center space-x-6 mb-4">
                        {/* Social Icons */}
                        <a href="https://github.com/ProjectEuropa" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-10 h-10 border border-cyber-blue/50 rounded-full text-foreground hover:text-cyber-blue hover:border-cyber-blue hover:shadow-[0_0_10px_#26dafd] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <a href="https://qiita.com/ProjectEuropa" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-10 h-10 border border-cyber-blue/50 rounded-full text-foreground hover:text-cyber-blue hover:border-cyber-blue hover:shadow-[0_0_10px_#26dafd] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <a href="https://zenn.dev/m2" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center w-10 h-10 border border-cyber-blue/50 rounded-full text-foreground hover:text-cyber-blue hover:border-cyber-blue hover:shadow-[0_0_10px_#26dafd] hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p className="text-sm opacity-80 font-mono">
                        &copy; 2016-{currentYear} <span className="text-cyber-blue">Team Project Europa</span> // All Systems Operational
                    </p>
                </CyberCard>
            </div>
        </footer>
