...
export default function CyberCard({ children, title, className = '' }: CyberCardProps) {
    return (
        <div className={`relative border border-cyber-blue shadow-[0_0_20px_rgba(38,218,253,0.4)] mb-8 overflow-hidden pt-1 group animate-frame-appear ${className}`}>
            {/* Top Pulse Line */}
